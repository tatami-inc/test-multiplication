...
```
$ ./build/dense_row/multiple_vectors/drmv_test
...
$ ./build/dense_row/multiple_vectors/drmv_test -r 200 -c 20000
...
$ ./build/dense_row/multiple_vectors/drmv_test -r 100000 -c 100
...
```
$ ./build/dense_row/multiple_vectors/drmv_test_float
Results for 10000 x 5000
...
$ ./build/dense_row/multiple_vectors/drmv_test_float -r 200 -c 20000
Results for 200 x 20000
...
$ ./build/dense_row/multiple_vectors/drmv_test_float -r 100000 -c 100
Results for 100000 x 100
...
Similar to the [single-vector case](../dense_row/single_vector), blocking gives a moderate speed-up with a block size of 16 elements.
