...
int main(int argc, char ** argv) {
    CLI::App app{"Timings for sparse row-major LHS, multiple vectors RHS"};
    std::size_t NR;
    ...
    names.emplace_back("blocked (B = 4), multiple accumulators");
    funs.emplace_back([&]() -> FLOAT {
    ...
    names.emplace_back("blocked (B = 8), multiple accumulators");
    funs.emplace_back([&]() -> FLOAT {
    ...
    names.emplace_back("blocked (B = 16), multiple accumulators");
    funs.emplace_back([&]() -> FLOAT {
    ...
    names.emplace_back("blocked (B = 32), multiple accumulators");
    funs.emplace_back([&]() -> FLOAT {
